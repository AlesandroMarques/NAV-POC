...
return (
    ...
    <p>Looking to consolidate onto an enterprise-class flash array without compromising performance, 
        ...
        HPE 3PAR Storage has you covered. Duologik is an HPE enterprise fully certified and service
         authorized reseller for 3 PAR technology.</p>
    <h6>HPE 3PAR Benefits</h6>
    <p>HPE 3PAR Storage delivers the performance advantages of a purpose-built, flash-optimized architecture
